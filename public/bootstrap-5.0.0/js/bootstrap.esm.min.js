...
var MAX_UID = 1e6,
  ...
  typeCheckConfig = function (e, t, n) {
    Object.keys(n).forEach(function (i) {
      var o = n[i],
        r = t[i],
        s = r && isElement(r) ? 'element' : toType(r);
  ...
  defineJQueryPlugin = function (e, t) {
  ...
  mapData = (function () {
    ...
    return {
      set: function (n, i, o) {
        (void 0 === n.bsKey && ((n.bsKey = { key: i, id: t }), t++), (e[n.bsKey.id] = o));
      },
      get: function (t, n) {
...
function normalizeParams(e, t, n) {
  var i = 'string' == typeof t,
    ...
    s = customEvents[r];
  return (s && (r = s), nativeEvents.has(r) || (r = e), [i, o, r]);
}
function addHandler(e, t, n, i, o) {
  if ('string' == typeof t && e) {
    ...
    var r = normalizeParams(t, n, i),
      ...
      E = getEvent(e),
      _ = E[l] || (E[l] = {}),
      c = findHandler(_, a, s ? n : null);
    if (c) c.oneOff = c.oneOff && o;
    else {
      var u = getUidEvent(a, t.replace(namespaceRegex, '')),
        d = s ? bootstrapDelegationHandler(e, n, i) : bootstrapHandler(e, n);
...
function removeNamespacedHandlers(e, t, n, i) {
  ...
  Object.keys(o).forEach(function (r) {
    if (r.includes(i)) {
      var s = o[r];
      removeHandler(e, t, n, s.originalHandler, s.delegationSelector);
    }
  });
}
var EventHandler = {
      ...
      if ('string' == typeof t && e) {
        ...
        if (void 0 === s) {
          ...
          Object.keys(c).forEach(function (n) {
            ...
            if (!l || t.includes(i)) {
              var o = c[n];
              removeHandler(e, E, a, o.originalHandler, o.delegationSelector);
            }
          });
        } else {
          if (!E || !E[a]) return;
          removeHandler(e, E, a, s, r ? n : null);
        }
      }
    },
  ...
  Alert = (function (e) {
    ...
    return (
      ...
      (n._getRootElement = function (e) {
        return getElementFromSelector(e) || e.closest('.' + CLASS_NAME_ALERT);
      }),
      ...
      (n._removeElement = function (e) {
        var t = this;
        if ((e.classList.remove(CLASS_NAME_SHOW), e.classList.contains(CLASS_NAME_FADE))) {
  ...
  Carousel = (function (e) {
    function t(t, n) {
      ...
      return (
        ...
        (i._indicatorsElement = SelectorEngine.findOne(SELECTOR_INDICATORS, i._element)),
        (i._touchSupported =
    ...
    return (
      ...
      (n._handleSwipe = function () {
        ...
        if (!(e <= SWIPE_THRESHOLD)) {
          ...
          ((this.touchDeltaX = 0),
            t > 0 && (isRTL ? this.next() : this.prev()),
            t < 0 && (isRTL ? this.prev() : this.next()));
        }
      }),
      ...
      (n._addTouchEventListeners = function () {
        var e = this,
          t = function (t) {
            !e._pointerEvent ||
            (t.pointerType !== POINTER_TYPE_PEN && t.pointerType !== POINTER_TYPE_TOUCH)
      ...
      (n._keydown = function (e) {
        /input|textarea/i.test(e.target.tagName) ||
          (e.key === ARROW_LEFT_KEY
            ? (e.preventDefault(), isRTL ? this.next() : this.prev())
            : e.key === ARROW_RIGHT_KEY && (e.preventDefault(), isRTL ? this.prev() : this.next()));
      }),
      ...
      (n._getItemByDirection = function (e, t) {
        ...
        var s = (o + (e === DIRECTION_PREV ? -1 : 1)) % this._items.length;
      ...
      (n._setActiveIndicatorElement = function (e) {
        if (this._indicatorsElement) {
          var t = SelectorEngine.findOne(SELECTOR_ACTIVE, this._indicatorsElement);
          (t.classList.remove(CLASS_NAME_ACTIVE$1), t.removeAttribute('aria-current'));
          for (
            var n = SelectorEngine.find(SELECTOR_INDICATOR, this._indicatorsElement), i = 0;
            i < n.length;
            i++
          )
            if (
              Number.parseInt(n[i].getAttribute('data-bs-slide-to'), 10) === this._getItemIndex(e)
            ) {
              (n[i].classList.add(CLASS_NAME_ACTIVE$1), n[i].setAttribute('aria-current', 'true'));
              break;
            }
        }
      }),
      ...
      (n._slide = function (e, t) {
        var n = this,
          ...
          l = e === DIRECTION_NEXT ? CLASS_NAME_START : CLASS_NAME_END,
          E = e === DIRECTION_NEXT ? CLASS_NAME_NEXT : CLASS_NAME_PREV,
          _ = e === DIRECTION_NEXT ? DIRECTION_LEFT : DIRECTION_RIGHT;
        if (r && r.classList.contains(CLASS_NAME_ACTIVE$1)) this._isSliding = !1;
        else if (!this._triggerSlideEvent(r, _).defaultPrevented && i && r) {
          if (
            ((this._isSliding = !0),
            a && this.pause(),
            ...
            (r.classList.add(E), reflow(r), i.classList.add(l), r.classList.add(l));
            var c = getTransitionDurationFromElement(i);
            (EventHandler.one(i, 'transitionend', function () {
              (r.classList.remove(l, E),
                r.classList.add(CLASS_NAME_ACTIVE$1),
                i.classList.remove(CLASS_NAME_ACTIVE$1, E, l),
                (n._isSliding = !1),
                setTimeout(function () {
                  EventHandler.trigger(n._element, EVENT_SLID, {
                    relatedTarget: r,
                    direction: _,
                    from: o,
                    to: s,
              ...
              emulateTransitionEnd(i, c));
          } else
            (i.classList.remove(CLASS_NAME_ACTIVE$1),
              r.classList.add(CLASS_NAME_ACTIVE$1),
              (this._isSliding = !1),
      ...
      (t.carouselInterface = function (e, n) {
        ...
        'object' == typeof n && (o = _extends({}, o, n));
...
var NAME$3 = 'collapse',
  ...
  Collapse = (function (e) {
    function t(t, n) {
      ...
      for (var o = SelectorEngine.find(SELECTOR_DATA_TOGGLE$1), r = 0, s = o.length; r < s; r++) {
        var a = o[r],
          l = getSelectorFromElement(a),
          E = SelectorEngine.find(l).filter(function (e) {
            return e === t;
          });
        null !== l && E.length && ((i._selector = l), i._triggerArray.push(a));
      }
      return (
    ...
    return (
      (n.toggle = function () {
        this._element.classList.contains(CLASS_NAME_SHOW$1) ? this.hide() : this.show();
      }),
      (n.show = function () {
        var e = this;
        if (!this._isTransitioning && !this._element.classList.contains(CLASS_NAME_SHOW$1)) {
          ...
          this._parent &&
            0 ===
              (n = SelectorEngine.find(SELECTOR_ACTIVES, this._parent).filter(function (t) {
          ...
          if (!EventHandler.trigger(this._element, EVENT_SHOW).defaultPrevented) {
            ...
            (EventHandler.one(this._element, 'transitionend', function () {
              (e._element.classList.remove(CLASS_NAME_COLLAPSING),
                e._element.classList.add(CLASS_NAME_COLLAPSE, CLASS_NAME_SHOW$1),
                (e._element.style[s] = ''),
        ...
        if (
          ...
          if (n > 0)
            for (var i = 0; i < n; i++) {
              ...
              r &&
                !r.classList.contains(CLASS_NAME_SHOW$1) &&
                (o.classList.add(CLASS_NAME_COLLAPSED), o.setAttribute('aria-expanded', !1));
            }
          ...
          (EventHandler.one(this._element, 'transitionend', function () {
            ...
            emulateTransitionEnd(this._element, s));
        }
      }),
      ...
      (n._addAriaAndCollapsedClass = function (e, t) {
        if (e && t.length) {
          var n = e.classList.contains(CLASS_NAME_SHOW$1);
          t.forEach(function (e) {
            (n ? e.classList.remove(CLASS_NAME_COLLAPSED) : e.classList.add(CLASS_NAME_COLLAPSED),
    ...
    return (
      (n.toggle = function () {
        if (!this._element.disabled && !this._element.classList.contains(CLASS_NAME_DISABLED)) {
          var e = this._element.classList.contains(CLASS_NAME_SHOW$2);
        ...
        if (
          ...
          if (!EventHandler.trigger(this._element, EVENT_SHOW$1, n).defaultPrevented) {
            if (this._inNavbar) Manipulator.setDataAttribute(this._menu, 'popper', 'none');
              ...
              'parent' === this._config.reference
                ...
                : isElement(this._config.reference)
                  ...
                  : 'object' == typeof this._config.reference && (i = this._config.reference);
              var o = this._getPopperConfig(),
                r = o.modifiers.find(function (e) {
                  return 'applyStyles' === e.name && !1 === e.enabled;
                });
              ((this._popper = createPopper(i, this._menu, o)),
                r && Manipulator.setDataAttribute(this._menu, 'popper', 'static'));
            }
            var s;
            ('ontouchstart' in document.documentElement &&
              ...
              EventHandler.trigger(this._element, EVENT_SHOWN$1, n));
          }
        }
      }),
      (n.hide = function () {
        if (
          ...
          EventHandler.trigger(this._element, EVENT_HIDE$1, e).defaultPrevented ||
            (this._popper && this._popper.destroy(),
            this._menu.classList.toggle(CLASS_NAME_SHOW$2),
            this._element.classList.toggle(CLASS_NAME_SHOW$2),
            Manipulator.removeDataAttribute(this._menu, 'popper'),
            EventHandler.trigger(this._element, EVENT_HIDDEN$1, e));
        }
      }),
      (n.dispose = function () {
        (e.prototype.dispose.call(this),
      ...
      (t.clearMenus = function (e) {
        if (!e || (e.button !== RIGHT_MOUSE_BUTTON && ('keyup' !== e.type || e.key === TAB_KEY)))
          for (
            var t = SelectorEngine.find(SELECTOR_DATA_TOGGLE$2), n = 0, i = t.length;
            n < i;
            n++
          ) {
            var o = Data.getData(t[n], DATA_KEY$4),
              r = { relatedTarget: t[n] };
            if ((e && 'click' === e.type && (r.clickEvent = e), o)) {
              var s,
                a = o._menu;
              if (
                t[n].classList.contains(CLASS_NAME_SHOW$2) &&
                !(
                  (e &&
                    (('click' === e.type && /input|textarea/i.test(e.target.tagName)) ||
                      ('keyup' === e.type && e.key === TAB_KEY)) &&
                    a.contains(e.target)) ||
                  EventHandler.trigger(t[n], EVENT_HIDE$1, r).defaultPrevented
                )
              )
                ('ontouchstart' in document.documentElement &&
                  (s = []).concat.apply(s, document.body.children).forEach(function (e) {
                  ...
                  a.classList.remove(CLASS_NAME_SHOW$2),
                  t[n].classList.remove(CLASS_NAME_SHOW$2),
                  Manipulator.removeDataAttribute(a, 'popper'),
                  EventHandler.trigger(t[n], EVENT_HIDDEN$1, r));
            }
          }
      }),
      ...
      (t.dataApiKeydownHandler = function (e) {
        if (
          ...
          var n = t.getParentFromElement(this),
            i = this.classList.contains(CLASS_NAME_SHOW$2);
          if (e.key === ESCAPE_KEY)
            return (
          ...
          if (i || (e.key !== ARROW_UP_KEY && e.key !== ARROW_DOWN_KEY))
...
(EventHandler.on(
  ...
  EventHandler.on(document, EVENT_CLICK_DATA_API$4, SELECTOR_DATA_TOGGLE$2, function (e) {
    ...
    return (
      ...
      (n.show = function (e) {
        ...
        if (!this._isShown && !this._isTransitioning) {
          this._element.classList.contains(CLASS_NAME_FADE$1) && (this._isTransitioning = !0);
          var n = EventHandler.trigger(this._element, EVENT_SHOW$2, { relatedTarget: e });
          this._isShown ||
            n.defaultPrevented ||
            ((this._isShown = !0),
      ...
      (n.hide = function (e) {
        ...
        if (
          ...
          this._isShown = !1;
          var n = this._element.classList.contains(CLASS_NAME_FADE$1);
          if (
      ...
      (n._showElement = function (e) {
        var t = this,
          n = this._element.classList.contains(CLASS_NAME_FADE$1),
        ...
        var o = function () {
          (t._config.focus && t._element.focus(),
            ...
            EventHandler.trigger(t._element, EVENT_SHOWN$2, { relatedTarget: e }));
        };
        if (n) {
          var r = getTransitionDurationFromElement(this._dialog);
          (EventHandler.one(this._dialog, 'transitionend', o),
        ...
        this._isShown
          ? EventHandler.on(this._element, EVENT_KEYDOWN_DISMISS, function (t) {
              e._config.keyboard && t.key === ESCAPE_KEY$1
                ...
                : e._config.keyboard || t.key !== ESCAPE_KEY$1 || e._triggerBackdropTransition();
            })
      ...
      (n._showBackdrop = function (e) {
        var t = this,
          n = this._element.classList.contains(CLASS_NAME_FADE$1) ? CLASS_NAME_FADE$1 : '';
        if (this._isShown && this._config.backdrop) {
            ...
            EventHandler.on(this._element, EVENT_CLICK_DISMISS, function (e) {
              t._ignoreBackdropClick
                ...
                : e.target === e.currentTarget &&
                  ('static' === t._config.backdrop ? t._triggerBackdropTransition() : t.hide());
            }),
          ...
          if (this._element.classList.contains(CLASS_NAME_FADE$1)) {
            ...
            (EventHandler.one(this._backdrop, 'transitionend', o),
          ...
          (EventHandler.off(this._element, 'transitionend'),
            EventHandler.one(this._element, 'transitionend', function () {
              (e._element.classList.remove(CLASS_NAME_STATIC),
                t ||
                  (EventHandler.one(e._element, 'transitionend', function () {
      ...
      (n._adjustDialog = function () {
        ...
        (((!this._isBodyOverflowing && e && !isRTL) || (this._isBodyOverflowing && !e && isRTL)) &&
      ...
      (n._setScrollbar = function () {
        ...
        (this._isBodyOverflowing &&
          ...
          this._setElementAttributes(SELECTOR_STICKY_CONTENT, 'marginRight', function (t) {
            return t - e._scrollbarWidth;
          }),
      ...
      (n._setElementAttributes = function (e, t, n) {
        SelectorEngine.find(e).forEach(function (e) {
          ...
          (Manipulator.setDataAttribute(e, t, i), (e.style[t] = n(Number.parseFloat(o)) + 'px'));
        });
      }),
  ...
  Tooltip = (function (e) {
    ...
    return (
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          if (!t.defaultPrevented && i) {
            ...
            (o.setAttribute('id', r),
              ...
              this.setContent(),
              this.config.animation && o.classList.add(CLASS_NAME_FADE$2));
            var s =
            ...
            (Data.setData(o, this.constructor.DATA_KEY, this),
              this._element.ownerDocument.documentElement.contains(this.tip) || l.appendChild(o),
              EventHandler.trigger(this._element, this.constructor.Event.INSERTED),
              (this._popper = createPopper(this._element, o, this._getPopperConfig(a))),
              o.classList.add(CLASS_NAME_SHOW$4));
            var E,
              _,
              c =
                'function' == typeof this.config.customClass
                  ...
                  : this.config.customClass;
            (c && (E = o.classList).add.apply(E, c.split(' ')),
              'ontouchstart' in document.documentElement &&
                (_ = []).concat.apply(_, document.body.children).forEach(function (e) {
            ...
            if (this.tip.classList.contains(CLASS_NAME_FADE$2)) {
              ...
              (EventHandler.one(this.tip, 'transitionend', u), emulateTransitionEnd(this.tip, d));
            } else u();
          }
        }
      }),
      (n.hide = function () {
        ...
        if (this._popper) {
          var t = this.getTipElement(),
            n = function () {
              (e._hoverState !== HOVER_STATE_SHOW && t.parentNode && t.parentNode.removeChild(t),
                e._cleanTipClass(),
          ...
          if (!EventHandler.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented) {
            var i;
            if (
              (t.classList.remove(CLASS_NAME_SHOW$4),
              'ontouchstart' in document.documentElement &&
              ...
              (EventHandler.one(t, 'transitionend', n), emulateTransitionEnd(t, o));
            } else n();
            this._hoverState = '';
          }
        }
      ...
      (n.setContent = function () {
        ...
        (this.setElementContent(SelectorEngine.findOne(SELECTOR_TOOLTIP_INNER, e), this.getTitle()),
          ...
          return 'object' == typeof t && isElement(t)
            ...
            : void (this.config.html
                ? (this.config.sanitize &&
                    (t = sanitizeHtml(t, this.config.allowList, this.config.sanitizeFn)),
                  (e.innerHTML = t))
                : (e.textContent = t));
      }),
      (n.getTitle = function () {
      ...
      (n._setListeners = function () {
        ...
        (this.config.trigger.split(' ').forEach(function (t) {
          if ('click' === t)
            EventHandler.on(e._element, e.constructor.Event.CLICK, e.config.selector, function (t) {
              return e.toggle(t);
            });
          else if (t !== TRIGGER_MANUAL) {
            var n =
                t === TRIGGER_HOVER ? e.constructor.Event.MOUSEENTER : e.constructor.Event.FOCUSIN,
              i =
                t === TRIGGER_HOVER ? e.constructor.Event.MOUSELEAVE : e.constructor.Event.FOCUSOUT;
      ...
      (n._enter = function (e, t) {
        ((t = this._initializeOnDelegatedTarget(e, t)),
          e && (t._activeTrigger['focusin' === e.type ? TRIGGER_FOCUS : TRIGGER_HOVER] = !0),
          t.getTipElement().classList.contains(CLASS_NAME_SHOW$4) ||
      ...
      (n._leave = function (e, t) {
        ((t = this._initializeOnDelegatedTarget(e, t)),
          e && (t._activeTrigger['focusout' === e.type ? TRIGGER_FOCUS : TRIGGER_HOVER] = !1),
    ...
    return (
      ...
      (n.setContent = function () {
        ...
        ('function' == typeof t && (t = t.call(this._element)),
          ...
          e.classList.remove(CLASS_NAME_FADE$3, CLASS_NAME_SHOW$5));
      }),
      (n._addAttachmentClass = function (e) {
      ...
      (t.jQueryInterface = function (e) {
        return this.each(function () {
          ...
          if (
            ...
            (n || ((n = new t(this, i)), Data.setData(this, DATA_KEY$7, n)), 'string' == typeof e)
          ) {
            if (void 0 === n[e]) throw new TypeError('No method named "' + e + '"');
            n[e]();
          }
...
var NAME$8 = 'scrollspy',
  ...
  ScrollSpy = (function (e) {
    function t(t, n) {
      var i;
      return (
        ((i = e.call(this, t) || this)._scrollElement = 'BODY' === t.tagName ? window : t),
        (i._config = i._getConfig(n)),
        (i._selector =
          i._config.target +
          ' ' +
        ...
        (i._scrollHeight = 0),
        EventHandler.on(i._scrollElement, EVENT_SCROLL, function () {
          return i._process();
        }),
        i.refresh(),
        i._process(),
    ...
    return (
      ...
      (n._getConfig = function (e) {
        if (
          'string' !=
            typeof (e = _extends({}, Default$6, 'object' == typeof e && e ? e : {})).target &&
          isElement(e.target)
        ) {
          var t = e.target.id;
      ...
      (n._activate = function (e) {
        ...
        (n.classList.contains(CLASS_NAME_DROPDOWN_ITEM)
          ...
          : (n.classList.add(CLASS_NAME_ACTIVE$2),
            SelectorEngine.parents(n, SELECTOR_NAV_LIST_GROUP).forEach(function (e) {
              (SelectorEngine.prev(e, SELECTOR_NAV_LINKS + ', ' + SELECTOR_LIST_ITEMS).forEach(
                function (e) {
    ...
    return (
      (n.show = function () {
        ...
        if (
          ...
          if (i) {
            var o =
              'UL' === i.nodeName || 'OL' === i.nodeName ? SELECTOR_ACTIVE_UL : SELECTOR_ACTIVE$1;
            t = (t = SelectorEngine.find(o, i))[t.length - 1];
          }
          var r = t
            ? EventHandler.trigger(t, EVENT_HIDE$3, { relatedTarget: this._element })
            : null;
          if (
            !(
              EventHandler.trigger(this._element, EVENT_SHOW$3, { relatedTarget: t })
                .defaultPrevented ||
            ...
            var s = function () {
              (EventHandler.trigger(t, EVENT_HIDDEN$3, { relatedTarget: e._element }),
                EventHandler.trigger(e._element, EVENT_SHOWN$3, { relatedTarget: t }));
            };
      ...
      (n._activate = function (e, t, n) {
        var i = this,
          ...
          r = n && o && o.classList.contains(CLASS_NAME_FADE$4),
          s = function () {
            return i._transitionComplete(e, o, n);
          };
        if (o && r) {
          var a = getTransitionDurationFromElement(o);
          (o.classList.remove(CLASS_NAME_SHOW$6),
            EventHandler.one(o, 'transitionend', s),
            emulateTransitionEnd(o, a));
        } else s();
      }),
      (n._transitionComplete = function (e, t, n) {
        ...
        (e.classList.add(CLASS_NAME_ACTIVE$3),
          ...
          reflow(e),
          e.classList.contains(CLASS_NAME_FADE$4) && e.classList.add(CLASS_NAME_SHOW$6),
          e.parentNode &&
    ...
    return (
      (n.show = function () {
        ...
        if (!EventHandler.trigger(this._element, EVENT_SHOW$4).defaultPrevented) {
          (this._clearTimeout(),
            this._config.animation && this._element.classList.add(CLASS_NAME_FADE$5));
          var t = function () {
            (e._element.classList.remove(CLASS_NAME_SHOWING),
              e._element.classList.add(CLASS_NAME_SHOW$7),
          ...
          if (
            ...
            (EventHandler.one(this._element, 'transitionend', t),
              emulateTransitionEnd(this._element, n));
          } else t();
        }
      }),
      (n.hide = function () {
        ...
        if (
          ...
          if ((this._element.classList.remove(CLASS_NAME_SHOW$7), this._config.animation)) {
            var n = getTransitionDurationFromElement(this._element);
            (EventHandler.one(this._element, 'transitionend', t),
              emulateTransitionEnd(this._element, n));
          } else t();

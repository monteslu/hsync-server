    ...
    <div class="card" style="width: 18rem; margin: 10px;">
      <div class="card-body">
        ...
        ${error
          ...
          : ''}
        ${pingResult ? html`<div class="alert alert-success" role="alert">${pingResult}</div>` : ''}
        ...
        <div class="mdl-card__supporting-text">
          <button class="btn btn-primary" disabled=${pinging} onClick=${sendPing}>Send Ping</button>
        </div>
      </div>
    </div>
  `;
